...
def main():
    ...
    if args.dataset == 'cifar10' or args.dataset == 'cifar100':
        ...
        H, W, C = 64, 64, 3
        num_class = 10
        model_dir = '/home/ssh685/ICCV2023/Colour-Quantisation-main/logs/CQ2/EuroSAT/2_colours/2023-06-04_16-18-28'
        normalize = T.Normalize((0.485, 0.456, 0.406), (0.229, 0.224, 0.225))
        train_trans = T.Compose([T.RandomCrop(64, padding=8), T.RandomHorizontalFlip(), T.ToTensor()  ])
        test_trans = T.Compose([T.ToTensor()  ])
        ...
        model_dir = '/home/ssh685/ICCV2023/Colour-Quantisation-main/logs/CQ2/AID/2_colours/2023-06-04_16-18-31'
        H, W, C = 600, 600, 3
        num_class = 30
        normalize = T.Normalize((0.485, 0.456, 0.406), (0.229, 0.224, 0.225))
    ...
    print(time)
    logdir = 'logs/XAI_CQ/{}/{}/'.format(args.dataset, time)
    ...
    # model
    CQ_model = torch.load(os.path.join(model_dir,'CQ_best.pth'), map_location='cpu')
    CQ_model = CQ_model.cuda()
    CQ_model.eval()
    classifier = torch.load(os.path.join(model_dir,'classifier_best.pth'), map_location='cpu')
    ...
    for batch_idx, (rgb, target) in enumerate(test_loader):
        ...
        B,C,H,W = rgb.shape
        with torch.no_grad():
            rgb,_ = CQ_model(rgb,training=False)
...
if __name__ == '__main__':
    main()
    # CUDA_VISIBLE_DEVICES=2 python XAI_CQ.py -d EuroSAT 
    # CUDA_VISIBLE_DEVICES=3 python XAI_CQ.py -d AID 
