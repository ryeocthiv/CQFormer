...
CUDA_VISIBLE_DEVICES=3 python train.py -d cifar10  --num_colors 8
...
CUDA_VISIBLE_DEVICES=7 python train.py -d cifar10  --num_colors 64
...
# CUDA_VISIBLE_DEVICES=3 python train.py -d cifar100  --num_colors 8
# CUDA_VISIBLE_DEVICES=4 python train.py -d cifar100  --num_colors 16
