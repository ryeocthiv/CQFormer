...
def visualise(num_colors,log_dir,dataset):
    ...
    save_img_dir = '/home/ssh685/ICCV2023/Colour-Quantisation-main/visualise/{}/{}/{}_colours/'.format(log_root.split('/')[-1],dataset, num_colors)
...
if __name__ == '__main__':
    ...
    # main()
    num_colors_list = [i for i in range(2,9)]
    log_root = '/home/ssh685/ICCV2023/Colour-Quantisation-main/logs/CQ3'
    dataset_list = os.listdir(log_root)
    dataset_list = [x for x in dataset_list if x!='CQformer_results_3']
    for num_colors in num_colors_list:
        for dataset in dataset_list:
            dataset_root = os.path.join(log_root,dataset,'{}_colours'.format(num_colors))
            log_time =  os.listdir(dataset_root)[-1]
